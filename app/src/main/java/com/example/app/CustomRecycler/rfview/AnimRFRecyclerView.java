package com.example.app.CustomRecycler.rfview;
...
import com.example.app.CustomRecycler.rfview.listener.OverScrollListener;
import com.example.app.CustomRecycler.rfview.manager.AnimRFGridLayoutManager;
import com.example.app.CustomRecycler.rfview.manager.AnimRFLinearLayoutManager;
import com.example.app.CustomRecycler.rfview.manager.AnimRFStaggeredGridLayoutManager;
...
public class AnimRFRecyclerView extends RecyclerView implements Runnable {
     ...
     * 拉伸到最高时头部的透明度
     */
    private float headerImageMinAlpha = 0.5f;
